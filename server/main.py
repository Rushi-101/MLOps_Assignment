...
model1 = Model("rf_deployed", "mlopsassgn1")
model2 = Model("knn_deployed", "mlopsassgn1")
...
async def create_upload_file(file: UploadFile = File(...)):
    ...
    if file.filename.endswith(".csv"):
        a = ['Time', 'V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V7', 'V8', 'V9', 'V10', 'V11', 'V12', 'V13', 'V14', 'V15', 'V16', 'V17', 'V18', 'V19', 'V20',
